...
def get_course_discussion_user_stats(
    ...
    usernames = matched_users_count = matched_users_pages = None
    if username_search_string:
        usernames, matched_users_count, matched_users_pages = get_usernames_from_search_string(
    ...
    if username_search_string:
        add_stats_for_users_with_no_discussion_content(course_stats_response["user_stats"], usernames)
    paginator = DiscussionAPIPagination(
        request,
